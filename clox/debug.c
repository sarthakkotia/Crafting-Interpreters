...
int disassembleInstruction(Chunk* chunk, int offset){
    ...
    switch (instruction) {
        ...
        case OP_CALL:
            return byteInstruction("OP_CALL", offset, chunk);
        case OP_CLOSURE: {
            offset++;
        ...
        case OP_GET_UPVALUE:
            return byteInstruction("OP_GET_UPVALUE", offset, chunk);
        case OP_SET_UPVALUE:
            return byteInstruction("OP_SET_UPVALUE", offset, chunk);
        case OP_CLASS:
        ...
        case OP_GET_VARIABLE_PROPERTY:
            return simpleInstruction("OP_GET_VARIABLE_PROPERTY", offset);
        case OP_SET_VARIABLE_PROPERTY:
            return simpleInstruction("OP_SET_VARIABLE_PROPERTY", offset);
        default:
