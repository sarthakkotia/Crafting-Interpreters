...
public class AstPrinter implements Expression.Visitor<String>, Statement.Visitor<String>{
    ...
    @Override
    public String visitGetExpression(Expression.Get get) {
        return get.object.accept(this) + " <get> " + get.name.lexeme;
    }

    @Override
    public String visitSetExpression(Expression.Set set) {
